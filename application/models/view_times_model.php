...
class View_times_model extends CI_Model {
	...
	function return_latest_set($limit = 1){
		if( !is_numeric($limit) ){ $limit = 1; }
		$limit = 'LIMIT '.$limit;
		$sql = 'SELECT * FROM view_times WHERE time_active = 1 AND time_count > 0 ORDER BY time_unix_time DESC '.$limit;
